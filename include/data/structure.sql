...
CREATE TABLE leden (
    ...
    woonplaats character varying(25) NOT NULL,
    email character varying(50) NOT NULL,
    geboortedatum date NOT NULL,
    geslacht character(1) NOT NULL,
    telefoonnummer_vast character varying(11),
...
-- Name: links; Type: TABLE; Schema: public; Owner: webcie; Tablespace: 
--
...
CREATE SEQUENCE links_categorie_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE links_categorie (
    id integer DEFAULT nextval('links_categorie_id_seq'::regclass) NOT NULL,
    titel text NOT NULL,
...
CREATE TABLE so_documenten (
    vak integer NOT NULL,
    titel character varying(150) NOT NULL,
    bestand character varying(150) NOT NULL,
    beschrijving text NOT NULL,
    id integer DEFAULT nextval(('so_documenten_id_seq'::text)::regclass),
...
CREATE SEQUENCE so_documenten_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE so_vakken_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: so_vakken; Type: TABLE; Schema: public; Owner: webcie; Tablespace: 
--

CREATE TABLE so_vakken (
    id integer DEFAULT nextval('so_vakken_id_seq'::regclass) NOT NULL,
    jaar smallint NOT NULL,
    naam character varying(100) NOT NULL,
    aantekeningen smallint,
    tentamens smallint,
...
-- Name: taken; Type: TABLE; Schema: public; Owner: webcie; Tablespace: 
--

CREATE TABLE taken (
    id integer DEFAULT nextval('taken_id_seq'::regclass) NOT NULL,
    taak text NOT NULL,
    beschrijving text NOT NULL,
    afgehandeld date,
    toegewezen integer,
...
--
-- TOC entry 2554 (class 0 OID 24140)
-- Dependencies: 174
-- Data for Name: agenda_moderate; Type: TABLE DATA; Schema: public; Owner: webcie
--



--
-- TOC entry 2556 (class 0 OID 24146)
-- Dependencies: 176
-- Data for Name: bedrijven_adres; Type: TABLE DATA; Schema: public; Owner: webcie
--

INSERT INTO bedrijven_adres VALUES (29, 'Studievereniging Cover', 'Nijenborgh 9', '9747 AG', NULL, '06 420 486 35', 'extern@svcover.nl', 'Sybren Römer', '2012-11-07 19:24:49.245068', 'Neem contact met ons op als je interesse hebt in een afstudeerplaats.', 'www.svcover.nl');
...
SELECT pg_catalog.setval('bedrijven_adres_id_seq', 29, true);


--
-- TOC entry 2558 (class 0 OID 24156)
-- Dependencies: 178
-- Data for Name: bedrijven_contactgegevens; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
SELECT pg_catalog.setval('bedrijven_contactgegevens_id_seq', 1, false);


--
-- TOC entry 2560 (class 0 OID 24165)
-- Dependencies: 180
-- Data for Name: bedrijven_stageplaatsen; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
SELECT pg_catalog.setval('bedrijven_stageplaatsen_id_seq', 10, true);


--
-- TOC entry 2561 (class 0 OID 24172)
-- Dependencies: 181
-- Data for Name: bestellingen; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
--
-- TOC entry 2601 (class 0 OID 24352)
-- Dependencies: 221
-- Data for Name: links; Type: TABLE DATA; Schema: public; Owner: webcie
--



--
-- TOC entry 2603 (class 0 OID 24362)
-- Dependencies: 223
-- Data for Name: links_categorie; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
SELECT pg_catalog.setval('links_categorie_id_seq', 2, true);
...
SELECT pg_catalog.setval('links_id_seq', 8, true);
...
--
-- TOC entry 2612 (class 0 OID 24414)
-- Dependencies: 232
...
--
-- TOC entry 2613 (class 0 OID 24420)
-- Dependencies: 233
-- Data for Name: so_documenten; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
SELECT pg_catalog.setval('so_documenten_id_seq', 31, true);


--
-- TOC entry 2616 (class 0 OID 24432)
-- Dependencies: 236
-- Data for Name: so_vakken; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
SELECT pg_catalog.setval('so_vakken_id_seq', 33, true);


--
-- TOC entry 2618 (class 0 OID 24441)
-- Dependencies: 238
-- Data for Name: taken; Type: TABLE DATA; Schema: public; Owner: webcie
--
...
--
-- TOC entry 2442 (class 2606 OID 26038)
-- Name: so_vakken_pkey; Type: CONSTRAINT; Schema: public; Owner: webcie; Tablespace: 
--

ALTER TABLE ONLY so_vakken
    ADD CONSTRAINT so_vakken_pkey PRIMARY KEY (id);
