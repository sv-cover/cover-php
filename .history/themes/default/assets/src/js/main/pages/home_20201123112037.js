...
const bulmaCollapsibleElement = document.getElementById('collapsible-open');
...
const bulmaCollapsibleElement2 = document.getElementById('collapsible-close');
if (bulmaCollapsibleElement2)
{
  new bulmaCollapsible(bulmaCollapsibleElement2);

  bulmaCollapsibleElement2.bulmaCollapsible('collapse');
}